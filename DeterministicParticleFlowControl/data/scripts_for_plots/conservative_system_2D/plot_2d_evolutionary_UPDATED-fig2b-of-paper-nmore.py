# -*- coding: utf-8 -*-
"""
Created on Tue Aug 16 14:55:30 2022
...
filename =  'evolutionary_rocken//Evolutionary_2d_rocken_WITH_PATHCOST_N_80__M_400_t2_0.700_non_clipped_controls.dat'  
...
for ni in nis:
    ...
    filename =  'evolutionary_rocken//Evolutionary_2d_rocken__PICE_WITH_PATHCOST_N_%d__t2_0.700_order_3d.dat'%(ni)
    file = open(filename,'rb')
    to_sav = pickle.load(file)
...
ax0.plot( np.mean(bridg2dB[0],axis=0), np.mean(bridg2dB[1],axis=0),'.',alpha=0.85, c='#900C3F',lw=2.5,label= r'mean $q_{t}(x)$') #cm.viridis(0.97)
ax0.plot( np.mean(bridg2dB[0],axis=0)+ np.std(bridg2dB[0],axis=0), np.mean(bridg2dB[1],axis=0) + np.std(bridg2dB[1],axis=0),'--',alpha=0.85,c='#900C3F',lw=2.5,label= r'std $q_{t}(x)$')
ax0.plot( np.mean(bridg2dB[0],axis=0)- np.std(bridg2dB[0],axis=0), np.mean(bridg2dB[1],axis=0) - np.std(bridg2dB[1],axis=0),'--',alpha=0.85, c='#900C3F',lw=2.5)
...
# ax0.plot( np.mean(bridg2d.Z[0],axis=0)- np.std(bridg2d.Z[0],axis=0), np.mean(bridg2d.Z[1],axis=0) - np.std(bridg2d.Z[1],axis=0),'--',alpha=0.85, c=cm.viridis(0.97),lw=2.5)
ax0.plot( (bridg2dZ[0,::2]).T, (bridg2dZ[1,::2]).T,alpha=0.51, c='grey',lw=0.55,label= r'$\rho_t(x)$ ')
ax0.plot( (bridg2dZ[0,::4,418]).T, (bridg2dZ[1,::4,418]).T,'.',alpha=0.91, c=cm.viridis(0.685),lw=0.5,markersize=2, label='particle')
ax0.plot( (bridg2dZ[0,::4,400:418]).T, (bridg2dZ[1,::4,400:418]).T,'-',alpha=0.71, c=cm.viridis(0.685),lw=1)
...
leg1 = ax0.legend(handles2b, labels2b, title=None,
          handletextpad=0.5, columnspacing=3.2,handlelength=0.8, bbox_to_anchor=[-0.55, 0.30955],labelspacing = 0.3,
...
leg2 = ax0.legend(handles2, labels2, title=None,
          handletextpad=0.5, columnspacing=3.2,handlelength=0.8, bbox_to_anchor=[-0.55, 1.0],labelspacing = 0.3,
          loc=2, ncol=1, frameon=True,fontsize = 'small',shadow=None,framealpha =0,edgecolor ='#0a0a0a')
...
ax0.set_xlim(-2,2)
ax0.set_ylim(0,2)
#ax0.set_xlabel(r'phenotype x')
#ax0.set_ylabel(r'phenotype y')
...
for ti in range(0,timegrid.size):
    if ti==timegrid.size-200:
        ax1.plot(Fcont[0,indx,ti:ti+2],Fcont[1,indx,ti:ti+2], c=cm.viridis(ti/(timegrid.size)),zorder=5,lw=1.8, label='controlled')
        ax1.plot(Fnon[0,0,ti:ti+2],Fnon[1,0,ti:ti+2], c=cm.copper(0.2+ti/(0.2+timegrid.size)), alpha=0.85,lw=1.8, label='uncontrolled')
    else:
        ax1.plot(Fcont[0,indx,ti:ti+2],Fcont[1,indx,ti:ti+2], c=cm.viridis(ti/(timegrid.size)),zorder=5,lw=1.8)
        ax1.plot(Fnon[0,0,ti:ti+2],Fnon[1,0,ti:ti+2], c=cm.copper(0.2+ti/(0.2+timegrid.size)), alpha=0.85,lw=1.8)
...
leg3 = ax1.legend(handles, labels, title=None,
          handletextpad=0.5, columnspacing=3.2,handlelength=0.8, bbox_to_anchor=[0.15, 1.3],
          loc=2, ncol=1, frameon=True,fontsize = 'small',shadow=None,framealpha =0,edgecolor ='#0a0a0a')#,bbox_transform=fig.transFigure)
...
plt.contourf(X, Y, speed.reshape(X.shape)  , cmap=plt.cm.BuPu_r,levels=150)
#plt.colorbar()
ax2.streamplot(X, Y, U.reshape(X.shape), V.reshape(Y.shape), density=[1, 1], color='#4f4949')



ax2.plot( np.mean(bridg2dB[0],axis=0), np.mean(bridg2dB[1],axis=0),'.',alpha=0.85, c='#900C3F',lw=2.5,label= r'mean $q_{t}(x)$') #cm.viridis(0.97)
ax2.plot( np.mean(bridg2dB[0],axis=0)+ np.std(bridg2dB[0],axis=0), np.mean(bridg2dB[1],axis=0) + np.std(bridg2dB[1],axis=0),linestyle=(0, (1, 3)),alpha=0.85,c='#900C3F',lw=2.5,label= r'std $q_{t}(x)$')
ax2.plot( np.mean(bridg2dB[0],axis=0)- np.std(bridg2dB[0],axis=0), np.mean(bridg2dB[1],axis=0) - np.std(bridg2dB[1],axis=0),linestyle=(0, (1, 3)),alpha=0.85, c='#900C3F',lw=2.5)


#ax0.plot( (bridg2d.Z[0]), (bridg2d.Z[1]),alpha=0.31, c='grey',lw=1)
ax2.plot( np.mean(Fcont[0],axis=0), np.mean(Fcont[1],axis=0),'-',alpha=0.85, c=cm.viridis(0.97),lw=2.5,label= r'mean $\hat{q}_{t}(x)$')
ax2.plot( np.mean(Fcont[0],axis=0)+ np.std(Fcont[0],axis=0), np.mean(Fcont[1],axis=0) + np.std(Fcont[1],axis=0),'--',alpha=0.85,c=cm.viridis(0.97),lw=2.5,label= r'std $\hat{q}_{t}(x)$')
ax2.plot( np.mean(Fcont[0],axis=0)- np.std(Fcont[0],axis=0), np.mean(Fcont[1],axis=0) - np.std(Fcont[1],axis=0),'--',alpha=0.85, c=cm.viridis(0.97),lw=2.5)
...
leg4 = ax2.legend(handles, labels, title=None,
          handletextpad=0.5, columnspacing=1.2,handlelength=0.8, bbox_to_anchor=[-0.1, 1.3],
          loc=2, ncol=2, frameon=True,fontsize = 'small',shadow=None,framealpha =0,edgecolor ='#0a0a0a')#,bbox_transform=fig.transFigure)
...
#plt.tight_layout()
plt.show()
plt.savefig(savefolder+'path_2d_pheno.png', bbox_inches='tight',dpi=300 , pad_inches = -0, transparent='False',  facecolor='white')
plt.savefig(savefolder+'path_2d_pheno.pdf', bbox_inches='tight',dpi=300,  pad_inches = -0, transparent='False',  facecolor='white')
...
#ax0.plot( (bridg2d.Z[0]), (bridg2d.Z[1]),alpha=0.31, c='grey',lw=1) '#C70039'
ax0.plot( np.mean(bridg2dB[0],axis=0), np.mean(bridg2dB[1],axis=0),'.',alpha=0.85, c='#900C3F',lw=2.5,label= r'$\mu_{q_{t}(x)}$') #cm.viridis(0.97)
ax0.plot( np.mean(bridg2dB[0],axis=0)+ np.std(bridg2dB[0],axis=0), np.mean(bridg2dB[1],axis=0) + np.std(bridg2dB[1],axis=0),'--',alpha=0.85,c='#900C3F',lw=2.5,label= r'$\sigma_{q_{t}(x)}$')
ax0.plot( np.mean(bridg2dB[0],axis=0)- np.std(bridg2dB[0],axis=0), np.mean(bridg2dB[1],axis=0) - np.std(bridg2dB[1],axis=0),'--',alpha=0.85, c='#900C3F',lw=2.5)
# ax0.plot( (bridg2d.B[0,::10]).T, (bridg2d.B[1,::10]).T,alpha=0.51, c='grey',lw=0.5)
# ax0.plot( (bridg2d.B[0,::10,200]).T, (bridg2d.B[1,::10,200]).T,'.',alpha=0.91, c=cm.viridis(0.685),lw=0.5,markersize=2)
# ax0.plot( (bridg2d.B[0,::10,200:218]).T, (bridg2d.B[1,::10,200:218]).T,'-',alpha=0.71, c=cm.viridis(0.685),lw=1)
...
# ax0.plot( np.mean(bridg2d.Z[0],axis=0)- np.std(bridg2d.Z[0],axis=0), np.mean(bridg2d.Z[1],axis=0) - np.std(bridg2d.Z[1],axis=0),'--',alpha=0.85, c=cm.viridis(0.97),lw=2.5)
ax0.plot( (bridg2dZ[0,::2]).T, (bridg2dZ[1,::2]).T,alpha=0.51, c='grey',lw=0.55,label= r'$\rho_t(x)$ ')
ax0.plot( (bridg2dZ[0,::4,418]).T, (bridg2dZ[1,::4,418]).T,'.',alpha=0.91, c=cm.viridis(0.685),lw=0.5,markersize=3, label='particle')
ax0.plot( (bridg2dZ[0,::4,400:418]).T, (bridg2dZ[1,::4,400:418]).T,'-',alpha=0.71, c=cm.viridis(0.685),lw=1)
...
labels2b = [labels[ii] for ii in [ -2,-1,-3  ] ]
leg1 = ax0.legend(handles2b, labels2b, title=None,
          handletextpad=0.5, columnspacing=3.2,handlelength=0.8, bbox_to_anchor=[-0.5, 0.30955],labelspacing = 0.3,
          loc=2, ncol=1, frameon=True,fontsize = 'large',shadow=None,framealpha =0,edgecolor ='#0a0a0a')
for text in leg1.get_texts():
    text.set_color('#4f4949')

leg2 = ax0.legend(handles2, labels2, title=None,
          handletextpad=0.5, columnspacing=3.2,handlelength=0.8, bbox_to_anchor=[-0.5, 1.0],labelspacing = 0.3,
          loc=2, ncol=1, frameon=True,fontsize = 'large',shadow=None,framealpha =0,edgecolor ='#0a0a0a')
for text in leg2.get_texts():
    text.set_color('#4f4949')
...
plt.savefig(savefolder+'App.with_path_2d_pheno_forward_particles_backward.png', bbox_inches='tight',dpi=300 , pad_inches = 1, transparent='False',  facecolor='white')
plt.savefig(savefolder+'App.with_path_2d_pheno_forward_particles_backward.pdf', bbox_inches='tight',dpi=300,  pad_inches = 1, transparent='False',  facecolor='white')
...
#  Varying density along a streamline
ax0 = fig.add_subplot(gs[0, 0])
plt.contourf(X, Y, speed.reshape(X.shape)  , cmap=plt.cm.BuPu_r,levels=150,alpha=0.65)
...
# ax0.plot( np.mean(bridg2d.Z[0],axis=0)+ np.std(bridg2d.Z[0],axis=0), np.mean(bridg2d.Z[1],axis=0) + np.std(bridg2d.Z[1],axis=0),'--',alpha=0.85,c=cm.viridis(0.97),lw=2.5)
# ax0.plot( np.mean(bridg2d.Z[0],axis=0)- np.std(bridg2d.Z[0],axis=0), np.mean(bridg2d.Z[1],axis=0) - np.std(bridg2d.Z[1],axis=0),'--',alpha=0.85, c=cm.viridis(0.97),lw=2.5)
ax0.plot( (bridg2dZ[0,::2]).T, (bridg2dZ[1,::2]).T,alpha=0.41, c='#C8C8C8',lw=0.55,label= r'$\rho_t(x)$ ')
ax0.plot( (bridg2dZ[0,::4,418]).T, (bridg2dZ[1,::4,418]).T,'.',alpha=0.91, c=cm.viridis(0.685),lw=0.5,markersize=3, label='particle')
ax0.plot( (bridg2dZ[0,::4,400:425]).T, (bridg2dZ[1,::4,400:425]).T,'-',alpha=0.71, c=cm.viridis(0.685),lw=1)
...
labels2b = [labels[ii] for ii in [ -2,-1,-3  ] ]
leg1 = ax0.legend(handles2b, labels2b, title=None,
          handletextpad=0.5, columnspacing=3.2,handlelength=0.8, bbox_to_anchor=[-0.52, 0.4255],labelspacing = 0.3,
          loc=2, ncol=1, frameon=True,fontsize = 'large',shadow=None,framealpha =0,edgecolor ='#0a0a0a')
for text in leg1.get_texts():
    text.set_color('#4f4949')

leg2 = ax0.legend(handles2, labels2, title=None,
          handletextpad=0.5, columnspacing=3.2,handlelength=0.8, bbox_to_anchor=[-0.52, 1.05],labelspacing = 0.3,
          loc=2, ncol=1, frameon=True,fontsize = 'large',shadow=None,framealpha =0,edgecolor ='#0a0a0a')
for text in leg2.get_texts():
    text.set_color('#4f4949')
...
ax2.plot( np.mean(bridg2dB[0],axis=0), np.mean(bridg2dB[1],axis=0),'.',alpha=0.85, c='#900C3F',lw=3.1,label= r'$\mu_{q_{t}}$') #cm.viridis(0.97)
ax2.plot( np.mean(bridg2dB[0],axis=0)+ np.std(bridg2dB[0],axis=0), np.mean(bridg2dB[1],axis=0) + np.std(bridg2dB[1],axis=0),'--',alpha=0.85,c='#900C3F',lw=3.2,label= r'$\sigma_{q_{t}}$')
ax2.plot( np.mean(bridg2dB[0],axis=0)- np.std(bridg2dB[0],axis=0), np.mean(bridg2dB[1],axis=0) - np.std(bridg2dB[1],axis=0),'--',alpha=0.85, c='#900C3F',lw=3.2)


#ax0.plot( (bridg2d.Z[0]), (bridg2d.Z[1]),alpha=0.31, c='grey',lw=1)
ax2.plot( np.mean(Fcont[0],axis=0), np.mean(Fcont[1],axis=0),'-',alpha=0.85, c=cm.viridis(0.97),lw=2.5,label= r' $\mu_{\hat{q}^{DPF}_{t}}$')
ax2.plot( np.mean(Fcont[0],axis=0)+ np.std(Fcont[0],axis=0), np.mean(Fcont[1],axis=0) + np.std(Fcont[1],axis=0),linestyle=(0, (1.5, 3)),alpha=0.85,c=cm.viridis(0.97),lw=2.5,label= r'$\sigma_{\hat{q}^{DPF}_{t}}$')
ax2.plot( np.mean(Fcont[0],axis=0)- np.std(Fcont[0],axis=0), np.mean(Fcont[1],axis=0) - np.std(Fcont[1],axis=0),linestyle=(0, (1.5, 3)),alpha=0.85, c=cm.viridis(0.97),lw=2.5)
# ax2.plot( (bridg2d.B[0,::10]).T, (bridg2d.B[1,::10]).T,alpha=0.51, c='grey',lw=0.5)
# ax2.plot( (bridg2d.B[0,::10,200]).T, (bridg2d.B[1,::10,200]).T,'.',alpha=0.91, c=cm.viridis(0.685),lw=0.5,markersize=2)
# ax2.plot( (bridg2d.B[0,::10,200:218]).T, (bridg2d.B[1,::10,200:218]).T,'-',alpha=0.71, c=cm.viridis(0.685),lw=1)
...
leg4 = ax2.legend(handles, labels, title=None,
          handletextpad=0.5, columnspacing=3.2,handlelength=0.8, bbox_to_anchor=[-0.53, 1.05],
          loc=2, ncol=1, frameon=True,fontsize = 'large',shadow=None,framealpha =0,edgecolor ='#0a0a0a')
for text in leg4.get_texts():
    text.set_color('#4f4949')

plt.savefig(savefolder+'App.with_path_2d_pheno_forward_backward_constrained_particles_backward_fade.png', bbox_inches='tight',dpi=300 , pad_inches = 1, transparent='False',  facecolor='white')
plt.savefig(savefolder+'App.with_path_2d_pheno_forward_backward_constrained_particles_backward_fade.pdf', bbox_inches='tight',dpi=300,  pad_inches = 1, transparent='False',  facecolor='white')
...
for N in Ns:
    ...
    for M in Ms:  
        ...
        for repi in range(1):
            ##load non path cost data: 
            filename =  'evolutionary_rocken//dpf_with_path//Evolutionary_2d_rocken_WITH_PATHCOST_M_%d__N_%d_t2_0.700_non_clipped_controls_repi_%d.dat'%(M,N,repi)  
            file = open(filename,'rb')
            to_sav = pickle.load(file)
            timegrid = to_sav['timegrid'] 
            y1 = to_sav['y1'] 
...
for ni in nis:
    ...
    for repi in range(1):
        ...
        filename =  'evolutionary_rocken//pice_with_path//Evolutionary_2d_rocken__PICE_WITH_PATHCOST_N_%d__t2_0.700_order_3_reps_%d.dat'%(ni,repi)
        file = open(filename,'rb')
        to_sav = pickle.load(file)
...
dpf_df = pd.DataFrame( columns = ['control', 'M','N','rep_u', 'path_error','end_error' ])
    ...
    for rep in range(1):
        for mi,M in enumerate(Ms):        
            data = {'control': np.power(np.sum(np.sqrt(np.nansum(np.power(used_uB[N][M][rep][:,:,:-1],2), axis=0)),axis=-1),2) /(T/dt) ,\
                    ...
                    'path_error': (np.nansum(np.power(FcontB[N][M][rep][1,:,:-1] -y2[1] ,2), axis=-1)) /(T/dt), \
                     'end_error': np.sqrt(np.sum( (FcontB[N][M][rep][:,:,-1]-np.atleast_2d(y2).T)**2 ,axis=0  ))  }       
            
            df1 =  pd.DataFrame(data, columns = ['control', 'M','N','rep_u', 'path_error', 'end_error'])
        ...
        data = {'control': np.power(np.sum(np.sqrt(np.nansum(np.power(used_upiceB[N][rep][:,:,:-1],2), axis=0)),axis=-1),2) /(T/dt) , \
                ...
                'path_error': (np.nansum(np.power(Fcont_piceB[N][rep][1,:,:-1] -y2[1] ,2), axis=-1)) /(T/dt), \
...
# Varying color along a streamline
gs01 = gridspec.GridSpecFromSubplotSpec(2, 2, subplot_spec=gs[0:2, 0:2], wspace=0.3)
ax1 = fig.add_subplot(gs01[0:2, 0])
plt.contourf(X, Y, speed.reshape(X.shape)  , cmap=plt.cm.BuPu_r,levels=150,alpha=0.8)
#strm = ax1.streamplot(X, Y, U.reshape(X.shape), V.reshape(X.shape), color=U.reshape(X.shape), linewidth=2, cmap='autumn')
strm = ax1.streamplot(X, Y, U.reshape(X.shape), V.reshape(X.shape), color='#4f4949', density=[0.75, 0.75])
...
for ti in range(0,timegrid.size):
    if ti==timegrid.size-200:
        ax1.plot(Fcont[0,indx,ti:ti+2],Fcont[1,indx,ti:ti+2], c=cm.viridis(ti/(timegrid.size)),zorder=5,lw=1.8, label=r'$X^{\mathrm{DPF}}_t$')
        ax1.plot(Fnon[0,0,ti:ti+2],Fnon[1,0,ti:ti+2], c=cm.copper(0.2+ti/(0.2+timegrid.size)), alpha=0.85,lw=1.8, label=r'$X^{\mathrm{unc}}_t$')
    elif ti==timegrid.size-1:
        ax1.plot(Fcont[0,indx,ti:ti+2],Fcont[1,indx,ti:ti+2], c=cm.viridis(ti/(timegrid.size)),zorder=1001,lw=1.8)
        ax1.plot(Fnon[0,0,ti:ti+2],Fnon[1,0,ti:ti+2], c=cm.copper(0.2+ti/(0.2+timegrid.size)), alpha=0.85,lw=1.8)
...
leg3 = ax1.legend(handles, labels, title=None,
          handletextpad=0.5, columnspacing=1.2,handlelength=0.8, bbox_to_anchor=[0.215, 0.95],
...
gs00 = gridspec.GridSpecFromSubplotSpec(2, 1, subplot_spec=gs01[0:2,1], hspace=0.1)
...
leg5 = ax3.legend(handlesb, labelsb, title=None,
          handletextpad=0.5, columnspacing=0.6,handlelength=0.8, bbox_to_anchor=[0.485, 1.05],
          loc=1, ncol=3, frameon=True,fontsize = 'large',shadow=None,framealpha =0,
          edgecolor ='#0a0a0a',bbox_transform=fig.transFigure)
...
plt.plot(timegrid,np.mean(Fcont[1],axis=0),linestyle=(0, (3, 3)), c=my_mag, lw=4, zorder=2)
...
dt = 0.001
T = t2
controls = np.log(np.array([np.power(np.sum(np.sqrt(np.nansum(np.power(used_u[:,:,:-1],2), axis=0)),axis=-1),2) /(T/dt), np.power(np.sum(np.sqrt(np.nansum(np.power(used_upice[ni_pice][:,:,:-1],2), axis=0)),axis=-1),2) /(T/dt)]) )
import pandas as pd
df = pd.DataFrame({r'DPF': controls[0, :], r'pice': controls[1, :]})
...
#ax5.set_yscale('log')
#######
ax5.annotate(u"$\sim 300$ iterations ",
...
plt.show()
plt.savefig(savefolder+'Evolutionary_with_path_2d_pheno_finalb.png', bbox_inches='tight',dpi=300 , pad_inches = 0., transparent='False',  facecolor='white')
plt.savefig(savefolder+'Evolutionary_with_path_2d_pheno_finalb.pdf', bbox_inches='tight',dpi=300,  pad_inches = 0., transparent='False',  facecolor='white')
