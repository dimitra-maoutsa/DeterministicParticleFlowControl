...
# -*- coding: utf-8 -*-
"""
Created on Sun Dec 12 01:11:03 2021
...
#
# DeterministicParticleFlowControl documentation build configuration file, created by
# sphinx-quickstart on Sun Dec 12 01:11:03 2021.
#
...
project = 'DeterministicParticleFlowControl'
copyright = '2021, Dimitra Maoutsa'
...
autodoc_mock_imports = ["ot", "logging", "math", "python-math", "POT"]
...
#html_sidebars = {   '**': [  'localtoc.html',  'navigation.html',  'relations.html', 'searchbox.html'  ]  }
...
man_pages = [
    ('index', 'DeterministicParticleFlowControl', 'DeterministicParticleFlowControl Documentation',
     ['Dimitra Maoutsa'], 1)
]
...
texinfo_documents = [
  ('index', 'DeterministicParticleFlowControl', 'DeterministicParticleFlowControl Documentation',
   'Dimitra Maoutsa', 'DeterministicParticleFlowControl', 'Stochastic Optimal Control with deterministic particles.',
   'Miscellaneous'),
]
