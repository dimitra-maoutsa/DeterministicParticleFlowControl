...
leg1 = ax0.legend(handles2b, labels2b, title=None,
          handletextpad=0.5, columnspacing=3.2,handlelength=0.8, bbox_to_anchor=[-0.65, 0.30955],labelspacing = 0.3,
          loc=2, ncol=1, frameon=True,fontsize = 'medium',shadow=None,framealpha =0,edgecolor ='#0a0a0a')
for text in leg1.get_texts():
    text.set_color('#4f4949')

leg2 = ax0.legend(handles2, labels2, title=None,
          handletextpad=0.5, columnspacing=3.2,handlelength=0.8, bbox_to_anchor=[-0.65, 1.0],labelspacing = 0.3,
          loc=2, ncol=1, frameon=True,fontsize = 'medium',shadow=None,framealpha =0,edgecolor ='#0a0a0a')
...
leg4 = ax2.legend(handles, labels, title=None,
          ...
          loc=2, ncol=2, frameon=True,fontsize = 'medium',shadow=None,framealpha =0,edgecolor ='#0a0a0a')
...
plt.subplots_adjust(hspace=0.3)#, 
                    #hspace=0.4)
plt.show()
plt.savefig(savefolder+'UPDATEDnon_path_2d_pheno.png', bbox_inches='tight',dpi=300 , pad_inches = -0, transparent='False',  facecolor='white')
plt.savefig(savefolder+'UPDATEDnon_path_2d_pheno.pdf', bbox_inches='tight',dpi=300,  pad_inches = -0, transparent='False', facecolor='white')
...
plt.savefig(savefolder+'UPDATEDApp.non_path_2d_pheno_forward_particles_backward.png', bbox_inches='tight',dpi=300 , pad_inches = 1, transparent='False',  facecolor='white')
plt.savefig(savefolder+'UPDATEDApp.non_path_2d_pheno_forward_particles_backward.pdf', bbox_inches='tight',dpi=300,  pad_inches = 1, transparent='False',  facecolor='white')
...
for ti in range(0,timegrid.size):
    if ti==timegrid.size-200:
        ...
        ax1.plot(Fnon[0,0,ti:ti+2],Fnon[1,0,ti:ti+2], c=cm.copper(0.2+ti/(0.2+timegrid.size)), alpha=0.85,lw=1.8, label='$X_t^{\mathrm{unc}}$')
...
leg3 = ax1.legend(handles, labels, title=None,
          ...
          loc=1, ncol=2, frameon=True,fontsize = 'large',shadow=None,framealpha =0,
...
ax3.set_ylabel(r'x', labelpad=-5)
ax4.set_ylabel(r'y', labelpad=5)
...
ax10.set_xlabel(r'')
ax10.tick_params(axis="both",direction="in", top=True, right=True,color='#4f4949')

#ax.yaxis.set_minor_locator(tck.AutoMinorLocator())
ax10.xaxis.set_minor_locator(tck.AutoMinorLocator())
ax10.tick_params(axis="both", which='minor',direction="in", top=True, right=True,color='#4f4949')
...
ax11.tick_params(axis="both", which='minor',direction="in", top=True, right=True, color='#4f4949')
plt.ylim(0.02,0.12)
fig.subplots_adjust(wspace=0.65,hspace=0.55)
#plt.tight_layout()
plt.show()
plt.savefig(savefolder+'Evolutionary_non_path_2d_pheno_final.png', bbox_extra_artists=(leg5,text), bbox_inches='tight',dpi=300 , pad_inches = 0.2, transparent='False',  facecolor='white')
plt.savefig(savefolder+'Evolutionary_non_path_2d_pheno_final.pdf', bbox_extra_artists=(leg5,text), bbox_inches='tight',dpi=300,  pad_inches = 0.2, transparent='False',  facecolor='white')
...
plt.savefig(savefolder+'App.non_path_2d_pheno_forward_backward_constrained_particles_backward_fade.png', bbox_inches='tight',dpi=300 , pad_inches = 1, transparent='False',  facecolor='white')
plt.savefig(savefolder+'App.non_path_2d_pheno_forward_backward_constrained_particles_backward_fade.pdf', bbox_inches='tight',dpi=300,  pad_inches = 1, transparent='False',  facecolor='white')
